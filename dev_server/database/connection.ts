...
export const resultConsoleConnection = 'DB_conection in'
config()
...
const DB_RE_CREATE:boolean  = process.env.DB_RE_CREATE_TABLES_WITH_DELETE_DATA == 'true' ? true : false
...
Connection.sync(
    ...
    console.log('DB_conection: connection database err')
})
